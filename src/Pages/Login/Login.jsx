  ...
  <div className="w-full flex px-5 justify-center items-center md:px-6 py-8 mx-auto md:h-max lg:py-0">
      ...
      <div className="w-full md:w-[85%] bg-white rounded-lg shadow dark:border md:mt-0 xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <h3 className="text-red-500 font-semibold text-xl">{error.slice(9, -1)}</h3>
                  <div>
                  ...
                  <div>
                      ...
                      <input type={passhide ? "password": "text"} {...register("password", { required: true })} name="password" id="password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="" />
                      <span className="absolute right-4">
                        {passhide? <FaEyeSlash onClick={() => setPasshide(!passhide)} />: <FaEye onClick={() => setPasshide(!passhide)} />}
                      </span>
                      </div>
                  </div>
                  <div className="flex items-center justify-between">
                      ...
                      <a href="#" className="text-sm font-medium text-[#0b86d6] hover:underline dark:text-primary-500">Forgot password?</a>
                  </div>
                  <button type="submit" className="w-full flex items-center justify-center gap-2 text-white bg-[#0b86d6] hover:bg-[#0f7fca] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#0b86d6] dark:hover:bg-[#1d4ed8] dark:focus:ring-primary-800">{loading ? (
                  <>
                    {" "}
                  ...
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                      Dont have an account yet? <Link to='/signup' className="font-medium text-[#0b86d6] hover:underline dark:text-primary-500">Sign up</Link>
                  </p>
